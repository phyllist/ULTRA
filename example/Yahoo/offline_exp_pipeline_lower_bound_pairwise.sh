...
export SETTING_ARGS="--data_dir=$Data_path/tmp_data/ --model_dir=$Data_path/tmp_model_${task_name}/ --output_dir=$Data_path/tmp_output/ --setting_file=./example/offline_setting_continuous/lower_bound_pairwise_exp_settings.json"
echo $SETTING_ARGS
